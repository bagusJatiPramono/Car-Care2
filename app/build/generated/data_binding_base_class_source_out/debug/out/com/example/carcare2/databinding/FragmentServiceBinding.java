...
public final class FragmentServiceBinding implements ViewBinding {
  ...
  @NonNull
  public final Button openDatePickerButton;
  ...
  private FragmentServiceBinding(@NonNull ConstraintLayout rootView, @NonNull Button continueButton,
      @NonNull Button openDatePickerButton, @NonNull RadioButton option1,
      @NonNull RadioButton option2, @NonNull RadioButton option3, @NonNull RadioGroup radioGroup) {
    this.rootView = rootView;
    this.continueButton = continueButton;
    this.openDatePickerButton = openDatePickerButton;
  ...
  public static FragmentServiceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.openDatePickerButton;
      Button openDatePickerButton = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentServiceBinding((ConstraintLayout) rootView, continueButton,
          openDatePickerButton, option1, option2, option3, radioGroup);
    }
